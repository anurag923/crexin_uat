...
export class CheckoutComponent implements OnInit {
  ...
  gstat12:any;
  discount_hourly:any;
  subtotlessdisc_hourly:any;
  gstat12_hourly:any;
  discount_daily:any;
  subtotlessdisc_daily:any;
  gstat12_daily:any;
  showtaxes_hourly:boolean;
  showtaxes_daily:boolean;
  showtaxes_weekly:boolean;
  daily_days:any;
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('time') == 'hourly') {
      ...
      this.h_sub_tot = this.h_no_hours * this.hourly_rate
      this.discount_hourly = this.h_sub_tot/10;
      this.subtotlessdisc_hourly = this.h_sub_tot - this.discount_hourly;
      this.gstat12_hourly = (12*this.subtotlessdisc_hourly)/100;
      this.h_sub_total = this.subtotlessdisc_hourly + this.gstat12_hourly;
    }
      ...
      this.d_paid_amount = this.d_sub_tot/10;
    }
      ...
      this.discount = this.w_total_weeks_amount/10; 
      this.subtotlessdisc = this.w_total_weeks_amount - this.discount;
      this.gstat12 = (12*this.subtotlessdisc)/100;
      this.w_sub_tot = this.subtotlessdisc + this.gstat12;
      this.w_paid_amount = this.w_sub_tot/5;

      console.log(this.w_total_weeks_amount,this.discount,this.subtotlessdisc, this.gstat12, this.w_sub_tot, this.w_paid_amount)
  ...
  endtime(starttime) {
    ...
    if((this.daily_days == "1") && (starttime == "09 - 10 AM")){
      this.end_time = "08 - 09 AM"
